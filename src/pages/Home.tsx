    ...
    <>
      <main className="flex min-h-dvh w-full items-center justify-center bg-dark px-5 pt-32 pb-24 font-jakarta-sans text-light">
        <section className="flex flex-col lg:flex-row gap-20 lg:items-center">
          <div>
            <h1 className="mt-10 max-w-2xl text-5xl font-extrabold text-pretty">
              Domina tus Finanzas con{' '}
              <span className="text-primary"> Ahorro Inteligente</span>
            </h1>
            <p className="mt-10 max-w-2xl text-xl text-pretty text-zinc-400">
              La plataforma diseñada para ayudarte a ahorrar sin esfuerzo.
              Automatiza tus metas, controla tus gastos y visualiza tu
              crecimiento financiero en tiempo real.{' '}
            </p>

            <Link
              to={redirectTo}
              className="mx-auto mt-12 inline-block rounded-3xl bg-primary px-8 py-3.5 font-semibold transition-colors duration-200 hover:bg-tertiary"
            >
              Empezar a ahorrar
            </Link>
          ...
          <div className="mt-12">
            <img
              ...
              className="size-96 w-full object-contain md:h-125"
            />
          </div>
        </section>
      </main>
